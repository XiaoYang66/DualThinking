"""
Dual Thinking Chain-of-Thought (CoT) System - Distill Variant

This module extends System3Base to use DeepSeek Distill model for thinking mode
...
from inference.deepseek_distill import request_distill
...
class System3Distill(System3Base):
    """
    System3Distill: 基于 System3Base 的 Distill 模型变体

    使用 DeepSeek Distill 模型进行 thinking 模式推理，
    ...
    def get_thinking_request_func(self):
        """返回 Distill 模型的 thinking 函数"""
        return request_distill
    ...
    def thinking_details(self) -> None:
        """
        阶段3：根据难度评分生成每个步骤的详细推理过程（Distill变体）
...
def inference_sysytem3(question: dict, args) -> bool:
    ...
    print("Starting System3Distill dual thinking inference...")
